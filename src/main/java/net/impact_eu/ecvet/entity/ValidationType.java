...
/**
 * 
 *                     According to: C 155/14 Annex 1 - Definitions (g) --- ‘Validation of learning outcomes’ means the process of confirming that certain assessed learning outcomes achieved by a learner correspond to specific outcomes which may be required for a unit or a qualification
 *                 
 * 
