...
import eu.open_ecvet.app.model.Learningagreement;
import eu.open_ecvet.app.model.LearningagreementAttachment;


public class LearningAgreementView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return LearningAgreementView.class.getSimpleName();
										}


										public void update()
										{
											nmListBox.setModel(LearningagreementAttachment.VT,"{$ATTACHMENT_TITLE}","ATTACHMENT_ID",true);
											table.refresh();
										}
									};
	
	
	public LearningAgreementView()
	{
		
	}
	
	
	public LearningAgreementView(MainWindow mainWindow)
	{
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setTabIndex(3);
		table.setPersistenceEnabled(false);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Learningagreement.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Learningagreement.TITLE");
