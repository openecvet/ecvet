...
import eu.open_ecvet.app.model.PartnerlistPartner;


public class PartnerListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return PartnerListView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(PartnerlistPartner.VT,
													"{$PARTNER_TITLE}","PARTNER_ID",true);
											table.refresh();
										}
									};
	...
	public PartnerListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Partnerlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevButton		partnerShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew, cmdSearch,
			deleteButton;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		partnerShortcut.setTabIndex(1);
		partnerShortcut.setText("Partner");
		partnerShortcut.setEnabled(false);
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Partnerlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Partnerlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Partnerlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Partnerlist.URI");
		...
		container.add(partnerShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,0,0),0,0));
		...
		nmListBox.setModel(PartnerlistPartner.VT,"{$PARTNER_TITLE}","PARTNER_ID",true);
