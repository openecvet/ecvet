...
import eu.open_ecvet.app.model.UserguidelistUserguide;


public class UserGuideListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return UserGuideListView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(UserguidelistUserguide.VT,
													"{$USERGUIDE_TITLE}","USERGUIDE_ID",true);
											table.refresh();
										}
									};
	
	
	public UserGuideListView()
	{
		
	}
	
	
	public UserGuideListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Userguidelist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Userguidelist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevButton		userGuideShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew, cmdSearch,
			deleteButton;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		userGuideShortcut = new XdevButton();
		table = new XdevTable();
		...
		userGuideShortcut.setTabIndex(1);
		userGuideShortcut.setText("Button");
		userGuideShortcut.setEnabled(false);
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Userguidelist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Userguidelist.TITLE");
		textField2.setTabIndex(5);
		textField2.setMaxSignCount(Integer.MAX_VALUE);
		textField2.setName("textField2");
		textField2.setHorizontalAlignment(SwingConstants.LEFT);
		label4.setText("User Guide");
		label3.setText("DESCRIPTION");
		label3.setName("label3");
		textArea.setDataField("eu.open_ecvet.app.model.Userguidelist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Userguidelist.URI");
		...
		container.add(userGuideShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,0,
				0),0,0));
		...
		nmListBox.setModel(UserguidelistUserguide.VT,"{$USERGUIDE_TITLE}","USERGUIDE_ID",true);
