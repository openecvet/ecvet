...
import eu.open_ecvet.app.model.Learningoutcometermlist;
import eu.open_ecvet.app.model.LearningoutcometermlistLearningoutcometerm;


public class LearningOutcomeTermListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return LearningOutcomeTermListView.class
													.getSimpleName();
										}
										...
										{
											nmListBox.setModel(
													LearningoutcometermlistLearningoutcometerm.VT,
													"{$LEARNINGOUTCOMETERM_TITLE}",
													"LEARNINGOUTCOMETERM_ID",true);
											table.refresh();
	...
	public LearningOutcomeTermListView()
	{
		
	}
	
	
	public LearningOutcomeTermListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Learningoutcometermlist.VT);
		}
		catch(DBException e)
		{
			e.printStackTrace();
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Learningoutcometermlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	@EventHandlerDelegate void learningOutcomeTermShortcut_actionPerformed(ActionEvent event) // ${GENERATED-CODE-BLOCK-START:EVENT_HANDLER_DELEGATE}
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		mainWindow.tabbedPane.setSelectedComponent(mainWindow.learningOutcomeTermTab);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}


	// Generated definitions, do not edit! ${GENERATED-CODE-BLOCK-START:DEFINITIONS}
	XdevContainer	container, container3, container2;
	XdevButton		learningOutcomeTermShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew,
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		learningOutcomeTermShortcut = new XdevButton();
		table = new XdevTable();
		...
		learningOutcomeTermShortcut.setTabIndex(1);
		learningOutcomeTermShortcut.setText("Learning Outcome Term");
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Learningoutcometermlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Learningoutcometermlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Learningoutcometermlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Learningoutcometermlist.URI");
		...
		container.add(learningOutcomeTermShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,0,0),0,0));
		...
		nmListBox.setModel(LearningoutcometermlistLearningoutcometerm.VT,"{$LEARNINGOUTCOMETERM_TITLE}","LEARNINGOUTCOMETERM_ID",true);
		...
		learningOutcomeTermShortcut.addActionListener(e -> learningOutcomeTermShortcut_actionPerformed(e));
