...
import eu.open_ecvet.app.model.CompetentinstitutionlistCompetentinstitution;
import eu.open_ecvet.app.model.Unitlist;


public class CompetentInstitutionListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return CompetentInstitutionListView.class
													.getSimpleName();
										}
										...
										public void update()
										{
											nmListBox
													.setModel(
															CompetentinstitutionlistCompetentinstitution.VT,
															"{$COMPETENTINSTITUTION_TITLE}",
															"COMPETENTINSTITUTION_ID",true);
											table.refresh();
										}
									};
	
	
	public CompetentInstitutionListView()
	{
		
	}
	
	
	public CompetentInstitutionListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Competentinstitutionlist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Competentinstitutionlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevButton		competentInstitutionShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew,
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		competentInstitutionShortcut = new XdevButton();
		table = new XdevTable();
		...
		competentInstitutionShortcut.setTabIndex(1);
		competentInstitutionShortcut.setText("Competent Institution");
		competentInstitutionShortcut.setEnabled(false);
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Competentinstitutionlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Competentinstitutionlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Competentinstitutionlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Competentinstitutionlist.URI");
		...
		container.add(competentInstitutionShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,
		...
		formular.add(nmListBox_carrier,new GBC(3,2,1,2,1.0,1.0,GBC.WEST,GBC.BOTH,
				new Insets(3,3,3,3),0,0));
		...
		formular.add(textField,new GBC(2,3,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,
				new Insets(3,3,3,3),0,0));
		formular.add(container3,new GBC(1,4,3,1,1.0,0.0,GBC.CENTER,GBC.HORIZONTAL,new Insets(3,3,3,
				3),0,0));
		...
		nmListBox.setModel(CompetentinstitutionlistCompetentinstitution.VT,
				"{$COMPETENTINSTITUTION_TITLE}","COMPETENTINSTITUTION_ID",true);
