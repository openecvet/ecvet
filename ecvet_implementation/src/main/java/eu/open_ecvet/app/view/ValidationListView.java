...
import eu.open_ecvet.app.model.ValidationlistValidation;


public class ValidationListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return ValidationListView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(ValidationlistValidation.VT,
													"{$VALIDATION_TITLE}","VALIDATION_ID",true);
											table.refresh();
											//	comboBox.refresh();
										}
									};
	...
	public ValidationListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Validationlist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Validationlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		xShortcut.setText("Validation");
		xShortcut.setEnabled(false);
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Validationlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Validationlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Validationlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Validationlist.URI");
		...
		nmListBox.setModel(ValidationlistValidation.VT,"{$VALIDATION_TITLE}","VALIDATION_ID",true);
