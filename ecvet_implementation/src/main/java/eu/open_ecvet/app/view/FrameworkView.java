...
public class FrameworkView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	XdevButton button2, button, qualificationShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew, cmdSearch, deleteButton;
	XdevTextField textField2, textField;
	XdevFormular formular;
	XdevTable table;
	XdevTextArea textArea;
	XdevComboBox competentInstitutionComboBox, complementaryDocumentsComboBox, qualificationComboBox;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setModel(Ecvetframework.VT, "TITLE, URI, COMPETENTINSTITUTIONLIST_TITLE, COMPLEMENTARYDOCUMENTS_TITLE, QUALIFICATION_TITLE", true);
		...
		competentInstitutionComboBox.setDataField("eu.open_ecvet.app.model.Ecvetframework.COMPETENTINSTITUTIONLIST_ID");
		...
		complementaryDocumentsComboBox.setDataField("eu.open_ecvet.app.model.Ecvetframework.COMPLEMENTARYDOCUMENTS_ID");
		...
		qualificationComboBox.setDataField("eu.open_ecvet.app.model.Ecvetframework.QUALIFICATION_ID");
		...
		container.add(qualificationShortcut, new GBC(3, 1, 1, 1, 0.0, 0.0, GBC.WEST, GBC.NONE, new Insets(0, 0, 0, 0), 0, 0));
		...
		formular.add(competentInstitutionComboBox, new GBC(2, 4, 1, 1, 1.0, 0.0, GBC.BASELINE_LEADING, GBC.HORIZONTAL, new Insets(3, 3, 3, 3), 0, 0));
		formular.add(label6, new GBC(1, 5, 1, 1, 0.0, 0.0, GBC.BASELINE_LEADING, GBC.NONE, new Insets(3, 3, 3, 3), 0, 0));
		formular.add(complementaryDocumentsComboBox, new GBC(2, 5, 1, 1, 1.0, 0.0, GBC.BASELINE_LEADING, GBC.HORIZONTAL, new Insets(3, 3, 3, 3), 0, 0));
		formular.add(label, new GBC(1, 6, 1, 1, 0.0, 0.0, GBC.BASELINE_LEADING, GBC.NONE, new Insets(3, 3, 3, 3), 0, 0));
		formular.add(qualificationComboBox, new GBC(2, 6, 1, 1, 1.0, 0.0, GBC.BASELINE_LEADING, GBC.HORIZONTAL, new Insets(3, 3, 3, 3), 0, 0));
