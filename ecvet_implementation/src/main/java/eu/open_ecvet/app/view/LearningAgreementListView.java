...
import eu.open_ecvet.app.model.LearningagreementlistLearningagreement;
import eu.open_ecvet.app.model.Unitlist;


public class LearningAgreementListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return LearningAgreementListView.class.getSimpleName();
										}
										...
										{
											nmListBox.setModel(
													LearningagreementlistLearningagreement.VT,
													"{$LEARNINGAGREEMENT_TITLE}",
													"LEARNINGAGREEMENT_ID",true);
											table.refresh();
										}
									};
	
	
	public LearningAgreementListView()
	{
		
	}
	
	
	public LearningAgreementListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Learningagreementlist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Learningagreementlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevButton		learningAgreementShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew, cmdSearch,
			deleteButton;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		learningAgreementShortcut = new XdevButton();
		table = new XdevTable();
		...
		learningAgreementShortcut.setTabIndex(1);
		learningAgreementShortcut.setText("Learning Agreement");
		learningAgreementShortcut.setEnabled(false);
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Learningagreementlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Learningagreementlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Learningagreementlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Learningagreementlist.URI");
		...
		container.add(learningAgreementShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,
		...
		nmListBox.setModel(LearningagreementlistLearningagreement.VT,"{$LEARNINGAGREEMENT_TITLE}",
				"LEARNINGAGREEMENT_ID",true);
