...
import eu.open_ecvet.app.model.ProcedureandguidelinelistProcedureandguideline;


public class ProcedureAndGuidelineListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return ProcedureAndGuidelineListView.class
													.getSimpleName();
										}
										...
										public void update()
										{
											nmListBox
													.setModel(
															ProcedureandguidelinelistProcedureandguideline.VT,
															"{$PROCEDUREANDGUIDELINE_TITLE}",
															"PROCEDUREANDGUIDELINE_ID",true);
											table.refresh();
											//	comboBox.refresh();
										}
									};
	...
	public ProcedureAndGuidelineListView()
	{
		
	}
	
	
	public ProcedureAndGuidelineListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Procedureandguidelinelist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Procedureandguidelinelist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setModel(Procedureandguidelinelist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Procedureandguidelinelist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Procedureandguidelinelist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Procedureandguidelinelist.URI");
		...
		nmListBox.setModel(ProcedureandguidelinelistProcedureandguideline.VT,"{$PROCEDUREANDGUIDELINE_TITLE}","PROCEDUREANDGUIDELINE_ID",true);
