...
import eu.open_ecvet.app.model.MemorandumofunderstandingAttachment;


public class MemorandumOfUnderstandingView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return MemorandumOfUnderstandingView.class
													.getSimpleName();
										}
										...
										{
											nmListBox.setModel(
													MemorandumofunderstandingAttachment.VT,
	...
	public MemorandumOfUnderstandingView()
	{
		
	}
	
	
	public MemorandumOfUnderstandingView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Memorandumofunderstanding.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Memorandumofunderstanding.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setModel(Memorandumofunderstanding.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Memorandumofunderstanding.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Memorandumofunderstanding.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Memorandumofunderstanding.URI");
		...
		nmListBox.setModel(MemorandumofunderstandingAttachment.VT,"{$ATTACHMENT_TITLE}","ATTACHMENT_ID",true);
