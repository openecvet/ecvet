...
import eu.open_ecvet.app.model.ReferencelevellistReferencelevel;


public class ReferenceLevelListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return ReferenceLevelListView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(ReferencelevellistReferencelevel.VT,
													"{$REFERENCELEVEL_TITLE}","REFERENCELEVEL_ID",
													true);
											table.refresh();
										}
									};
	...
	public ReferenceLevelListView()
	{
		
	}
	
	
	public ReferenceLevelListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Referencelevellist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Referencelevellist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevButton		referenceLevelShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew, cmdSearch,
			deleteButton;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		referenceLevelShortcut.setTabIndex(1);
		referenceLevelShortcut.setText("Reference Level");
		referenceLevelShortcut.setEnabled(false);
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Referencelevellist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Referencelevellist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Referencelevellist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Referencelevellist.URI");
		...
		container.add(referenceLevelShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,0,0),0,0));
		...
		nmListBox.setModel(ReferencelevellistReferencelevel.VT,"{$REFERENCELEVEL_TITLE}","REFERENCELEVEL_ID",true);
