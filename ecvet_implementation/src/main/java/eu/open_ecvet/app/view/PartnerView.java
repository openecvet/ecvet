...
import eu.open_ecvet.app.model.Partner;
import eu.open_ecvet.app.model.Unitlist;


public class PartnerView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return PartnerView.class.getSimpleName();
										}
	...
	public PartnerView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Partner.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setModel(Partner.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Partner.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Partner.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Partner.URI");
		...
		formular.add(label3,new GBC(1,2,1,1,0.1,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,new Insets(
				3,3,3,3),0,0));
