...
import eu.open_ecvet.app.model.CertificatetemplateAttachment;


public class CertificateTemplateView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return CertificateTemplateView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(CertificatetemplateAttachment.VT,"{$ATTACHMENT_TITLE}","ATTACHMENT_ID",true);
											table.refresh();
										}
									};
	
	
	public CertificateTemplateView()
	{
		
	}
	
	
	public CertificateTemplateView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Certificatetemplate.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Certificatetemplate.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setModel(Certificatetemplate.VT,"DESCRIPTION, TITLE",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Certificatetemplate.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Certificatetemplate.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Certificatetemplate.URI");
