...
import eu.open_ecvet.app.model.RecognitionlistRecognition;
import eu.open_ecvet.app.model.Unitlist;


public class RecognitionListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return RecognitionListView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(RecognitionlistRecognition.VT,
													"{$RECOGNITION_TITLE}","RECOGNITION_ID",true);
											table.refresh();
										}
									};
	
	
	public RecognitionListView()
	{
		
	}
	
	
	public RecognitionListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Recognitionlist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Recognitionlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevButton		recognitionShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew, cmdSearch,
			deleteButton;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		recognitionShortcut = new XdevButton();
		table = new XdevTable();
		...
		recognitionShortcut.setTabIndex(1);
		recognitionShortcut.setText("Recognition");
		recognitionShortcut.setEnabled(false);
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Recognitionlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Recognitionlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Recognitionlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Recognitionlist.URI");
		...
		container.add(recognitionShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,
				0,0),0,0));
		...
		nmListBox.setModel(RecognitionlistRecognition.VT,"{$RECOGNITION_TITLE}","RECOGNITION_ID",
				true);
