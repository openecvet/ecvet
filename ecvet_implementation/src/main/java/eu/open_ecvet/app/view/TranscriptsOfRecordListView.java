...
public class TranscriptsOfRecordListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return TranscriptsOfRecordListView.class.getSimpleName();
										}
	...
	public TranscriptsOfRecordListView()
	{
		
	}
	
	
	public TranscriptsOfRecordListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
				...
				{
					formular.delete();
					formular.reset(Transcriptsofrecordlist.VT);
				}
				catch(DBException e)
				{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Transcriptsofrecordlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevLabel		label2, label5, label3, label;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setModel(Transcriptsofrecordlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Transcriptsofrecordlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Transcriptsofrecordlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Transcriptsofrecordlist.URI");
		...
		formular.add(label5,new GBC(3,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(3,3,3,3),0,0));
