...
public class LegislationView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return LegislationView.class.getSimpleName();
										}
	...
	public LegislationView()
	{
		
	}
	
	
	public LegislationView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Legislation.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setTabIndex(3);
		table.setModel(Legislation.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Legislation.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Legislation.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		label4.setText("PRACTICES");
		label4.setName("label4");
		textField3.setDataField("eu.open_ecvet.app.model.Legislation.PRACTICES");
		...
		textField4.setDataField("eu.open_ecvet.app.model.Legislation.RULES");
		...
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Legislation.URI");
