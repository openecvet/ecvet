...
import eu.open_ecvet.app.model.LegislationlistLegislation;


public class LegislationListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return LegislationListView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(LegislationlistLegislation.VT,
													"{$LEGISLATION_TITLE}","LEGISLATION_ID",true);
											table.refresh();
											//	comboBox.refresh();
										}
									};
	...
	public LegislationListView()
	{
		
	}
	
	
	public LegislationListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Legislationlist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Legislationlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setModel(Legislationlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Legislationlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Legislationlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Legislationlist.URI");
		...
		nmListBox.setModel(LegislationlistLegislation.VT,"{$LEGISLATION_TITLE}","LEGISLATION_ID",true);
