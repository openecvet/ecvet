...
import eu.open_ecvet.app.model.Assessment;
import eu.open_ecvet.app.model.Methodlist;
import eu.open_ecvet.app.model.Processlist;


public class AssessmentView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return AssessmentView.class.getSimpleName();
										}
										
										
										public void update()
										{
											methodListComboBox.setModel(Methodlist.VT,"TITLE","ID",
													true);
											processListComboBox.setModel(Processlist.VT,"TITLE",
													"ID",true);
											table.refresh();
	...
	public AssessmentView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Assessment.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevButton		methodListShortcut, processListShortcut, cmdNew, cmdReset, cmdSave,
			cmdSaveAndNew, cmdSearch, deleteButton;
	XdevTextField	textField2, textField;
	XdevFormular	formular;
	XdevTable		table;
	XdevTextArea	textArea;
	XdevComboBox	methodListComboBox, processListComboBox;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		methodListShortcut = new XdevButton();
		processListShortcut = new XdevButton();
		table = new XdevTable();
		...
		methodListComboBox = new XdevComboBox();
		label = new XdevLabel();
		processListComboBox = new XdevComboBox();
		...
		methodListShortcut.setTabIndex(1);
		methodListShortcut.setText("Method List");
		methodListShortcut.setEnabled(false);
		processListShortcut.setTabIndex(15);
		processListShortcut.setText("Process List");
		processListShortcut.setName("methodListShortcut2");
		processListShortcut.setEnabled(false);
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Assessment.VT,"TITLE, URI, METHODLIST_TITLE, PROCESSLIST_TITLE",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Assessment.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Assessment.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		label4.setText("URI");
		label4.setName("label4");
		textField.setDataField("eu.open_ecvet.app.model.Assessment.URI");
		textField.setTabIndex(7);
		textField.setMaxSignCount(Integer.MAX_VALUE);
		textField.setHorizontalAlignment(SwingConstants.LEFT);
		label5.setText("METHODLIST_ID");
		label5.setName("label5");
		methodListComboBox.setDataField("eu.open_ecvet.app.model.Assessment.METHODLIST_ID");
		methodListComboBox.setTabIndex(8);
		methodListComboBox.setName("comboBox2");
		methodListComboBox.setModel(Methodlist.VT,"TITLE","ID",true);
		label.setText("PROCESSLIST_ID");
		processListComboBox.setDataField("eu.open_ecvet.app.model.Assessment.PROCESSLIST_ID");
		processListComboBox.setTabIndex(9);
		processListComboBox.setModel(Processlist.VT,"TITLE","ID",true);
		...
		textField.saveState();
		label5.saveState();
		methodListComboBox.saveState();
		label.saveState();
		processListComboBox.saveState();
		
		container.setLayout(new GridBagLayout());
		container.add(methodListShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,0,0),0,0));
		container.add(processListShortcut,new GBC(2,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,0,0),0,0));
		...
		formular.add(methodListComboBox,new GBC(2,4,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,new Insets(3,3,3,3),0,0));
		formular.add(label,new GBC(1,5,1,1,0.0,0.0,GBC.BASELINE_LEADING,GBC.NONE,new Insets(3,3,3,3),0,0));
		formular.add(processListComboBox,new GBC(2,5,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,new Insets(3,3,3,3),0,0));
