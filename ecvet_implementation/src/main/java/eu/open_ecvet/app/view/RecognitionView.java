...
import eu.open_ecvet.app.model.Certificatetemplate;
import eu.open_ecvet.app.model.Recognition;


public class RecognitionView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return RecognitionView.class.getSimpleName();
										}
										
										
										public void update()
										{
											certificateTemplateComboBox.setModel(
													Certificatetemplate.VT,"TITLE","ID",true);
											table.refresh();
										}
									};
	...
	public RecognitionView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Recognition.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevButton		certificateTemplateShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew,
			cmdSearch, deleteButton;
	XdevTextField	textField2, textField3, textField;
	XdevFormular	formular;
	XdevTable		table;
	XdevTextArea	textArea;
	XdevComboBox	certificateTemplateComboBox;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		certificateTemplateShortcut = new XdevButton();
		table = new XdevTable();
		...
		label = new XdevLabel();
		certificateTemplateComboBox = new XdevComboBox();
		...
		certificateTemplateShortcut.setTabIndex(1);
		certificateTemplateShortcut.setText("Certificate Template");
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Recognition.VT,"TITLE, URI, CERTIFICATETEMPLATE_TITLE",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Recognition.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Recognition.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		label4.setText("COMPETENTINSTITUTIONURI");
		label4.setName("label4");
		textField3.setDataField("eu.open_ecvet.app.model.Recognition.COMPETENTINSTITUTIONURI");
		...
		textField.setDataField("eu.open_ecvet.app.model.Recognition.URI");
		textField.setTabIndex(8);
		textField.setMaxSignCount(Integer.MAX_VALUE);
		textField.setHorizontalAlignment(SwingConstants.LEFT);
		label.setText("CERTIFICATETEMPLATE_ID");
		certificateTemplateComboBox.setDataField("eu.open_ecvet.app.model.Recognition.CERTIFICATETEMPLATE_ID");
		certificateTemplateComboBox.setTabIndex(9);
		certificateTemplateComboBox.setModel(Certificatetemplate.VT,"TITLE","ID",true);
		...
		textField.saveState();
		label.saveState();
		certificateTemplateComboBox.saveState();
		
		container.setLayout(new GridBagLayout());
		container.add(certificateTemplateShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,0,0),0,0));
		...
		formular.add(certificateTemplateComboBox,new GBC(2,5,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,new Insets(3,3,3,3),0,0));
