...
public class UnitListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public void update()
										{
											nmListBox.setModel(UnitlistUnit.VT,"{$UNIT_TITLE}","UNIT_ID",true);
											table.refresh();
										}
									};
	...
	@EventHandlerDelegate void unitShortcut_actionPerformed(ActionEvent event) // ${GENERATED-CODE-BLOCK-START:EVENT_HANDLER_DELEGATE}
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		formular.add(container3,new GBC(1,4,3,1,1.0,0.0,GBC.WEST,GBC.HORIZONTAL,new Insets(3,3,3,3),0,0));
