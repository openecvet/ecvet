...
import eu.open_ecvet.app.model.Credittransfer;
import eu.open_ecvet.app.model.CredittransferAttachment;
import eu.open_ecvet.app.model.Unitlist;


public class CreditTransferView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return CreditTransferView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(CredittransferAttachment.VT,
	...
	public CreditTransferView()
	{
		
	}
	
	
	public CreditTransferView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Credittransfer.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Credittransfer.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setTabIndex(3);
		table.setModel(Credittransfer.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Credittransfer.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Credittransfer.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Credittransfer.URI");
		...
		nmListBox.setModel(CredittransferAttachment.VT,"{$ATTACHMENT_TITLE}","ATTACHMENT_ID",true);
