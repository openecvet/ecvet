...
import eu.open_ecvet.app.model.Requirementlist;
...
public class ValidationView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public void update()
										{
											requirementListComboBox.setModel(Requirementlist.VT,"TITLE","ID",true);
											table.refresh();
											//	comboBox.refresh();
										}
									};
	...
	XdevComboBox	requirementListComboBox;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		label = new XdevLabel();
		requirementListComboBox = new XdevComboBox();
		...
		table.setModel(Validation.VT,"TITLE, URI, REQUIREMENTLIST_TITLE",true);
		...
		textField3.setDataField("eu.open_ecvet.app.model.Validation.ASSESSMENTURI");
		...
		label.setText("REQUIREMENTLIST_ID");
		requirementListComboBox.setDataField("eu.open_ecvet.app.model.Validation.REQUIREMENTLIST_ID");
		requirementListComboBox.setTabIndex(9);
		requirementListComboBox.setModel(Requirementlist.VT,"TITLE","ID",true);
		...
		textField.saveState();
		label.saveState();
		requirementListComboBox.saveState();
		
		container.setLayout(new GridBagLayout());
		container.add(confirmingRequirementListShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,0,0),0,0));
		...
		formular.add(requirementListComboBox,new GBC(2,5,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,new Insets(3,3,3,3),0,0));
