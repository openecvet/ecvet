...
import eu.open_ecvet.app.model.TranscriptionofrecordlistTranscriptionofrecord;
import eu.open_ecvet.app.model.Unitlist;


public class TranscriptionOfRecordListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return TranscriptionOfRecordListView.class
													.getSimpleName();
										}
										...
										public void update()
										{
											nmListBox
													.setModel(
															TranscriptionofrecordlistTranscriptionofrecord.VT,
															"{$TRANSCRIPTIONOFRECORD_TITLE}",
															"TRANSCRIPTIONOFRECORD_ID",true);
											table.refresh();
										}
									};
	
	
	public TranscriptionOfRecordListView()
	{
		
	}
	
	
	public TranscriptionOfRecordListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Transcriptionofrecordlist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Transcriptionofrecordlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setTabIndex(3);
		table.setModel(Transcriptionofrecordlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Transcriptionofrecordlist.TITLE");
		textField2.setTabIndex(5);
		textField2.setMaxSignCount(Integer.MAX_VALUE);
		textField2.setName("textField2");
		textField2.setHorizontalAlignment(SwingConstants.LEFT);
		label4.setText("Transcription of Record");
		label3.setText("DESCRIPTION");
		label3.setName("label3");
		textArea.setDataField("eu.open_ecvet.app.model.Transcriptionofrecordlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Transcriptionofrecordlist.URI");
		...
		nmListBox.setModel(TranscriptionofrecordlistTranscriptionofrecord.VT,
				"{$TRANSCRIPTIONOFRECORD_TITLE}","TRANSCRIPTIONOFRECORD_ID",true);
