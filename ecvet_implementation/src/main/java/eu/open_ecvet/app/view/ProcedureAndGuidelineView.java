...
import eu.open_ecvet.app.model.Procedureandguideline;
import eu.open_ecvet.app.model.Unitlist;


public class ProcedureAndGuidelineView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return ProcedureAndGuidelineView.class.getSimpleName();
										}
	...
	public ProcedureAndGuidelineView()
	{
		
	}
	
	
	public ProcedureAndGuidelineView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Procedureandguideline.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Procedureandguideline.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevTextField	textField2, textField3, textField4, textField, textField5;
	XdevFormular	formular;
	XdevTable		table;
	XdevTextArea	textArea;
	XdevLabel		label2, label3, label4, label5, label, label6;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setModel(Procedureandguideline.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Procedureandguideline.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Procedureandguideline.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		label4.setText("ASSESSMENT");
		label4.setName("label4");
		textField3.setDataField("eu.open_ecvet.app.model.Procedureandguideline.ASSESSMENT");
		...
		label5.setText("RECOGNITION");
		label5.setName("label5");
		textField4.setDataField("eu.open_ecvet.app.model.Procedureandguideline.RECOGNITION");
		...
		textField.setDataField("eu.open_ecvet.app.model.Procedureandguideline.VALIDATION");
		textField.setTabIndex(10);
		textField.setMaxSignCount(Integer.MAX_VALUE);
		textField.setHorizontalAlignment(SwingConstants.LEFT);
		label6.setText("URI");
		label6.setName("label6");
		textField5.setDataField("eu.open_ecvet.app.model.Procedureandguideline.URI");
		textField5.setTabIndex(9);
		...
		formular.add(label5,new GBC(1,4,1,1,0.0,0.0,GBC.BASELINE_LEADING,GBC.NONE,new Insets(3,3,3,
				3),0,0));
		formular.add(textField4,new GBC(2,4,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,
				new Insets(3,3,3,3),0,0));
		...
		formular.add(textField,new GBC(2,5,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,
				new Insets(3,3,3,3),0,0));
		formular.add(label6,new GBC(1,6,1,1,0.0,0.0,GBC.BASELINE_LEADING,GBC.NONE,new Insets(3,3,3,
				3),0,0));
		formular.add(textField5,new GBC(2,6,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,
				new Insets(3,3,3,3),0,0));
