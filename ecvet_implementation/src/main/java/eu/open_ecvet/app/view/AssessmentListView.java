...
import eu.open_ecvet.app.model.AssessmentlistAssessment;


public class AssessmentListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return AssessmentListView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(AssessmentlistAssessment.VT,
													"{$ASSESSMENT_TITLE}","ASSESSMENT_ID",true);
											table.refresh();
	...
	public AssessmentListView()
	{
		
	}
	
	
	public AssessmentListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Assessmentlist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Assessmentlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	@EventHandlerDelegate void assessmentShortcut_actionPerformed(ActionEvent event) // ${GENERATED-CODE-BLOCK-START:EVENT_HANDLER_DELEGATE}
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		mainWindow.tabbedPane.setSelectedComponent(mainWindow.assessmentTab);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}


	// Generated definitions, do not edit! ${GENERATED-CODE-BLOCK-START:DEFINITIONS}
	XdevContainer	container, container3, container2;
	XdevButton		assessmentShortcut, cmdNew, cmdReset, cmdSave, cmdSaveAndNew, cmdSearch,
			deleteButton;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		assessmentShortcut = new XdevButton();
		table = new XdevTable();
		...
		assessmentShortcut.setTabIndex(1);
		assessmentShortcut.setText("Assessment");
		table.setTabIndex(3);
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setModel(Assessmentlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Assessmentlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Assessmentlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Assessmentlist.URI");
		...
		container.add(assessmentShortcut,new GBC(1,1,1,1,0.0,0.0,GBC.WEST,GBC.NONE,new Insets(0,0,0,0),0,0));
		...
		nmListBox.setModel(AssessmentlistAssessment.VT,"{$ASSESSMENT_TITLE}","ASSESSMENT_ID",true);
		...
		assessmentShortcut.addActionListener(e -> assessmentShortcut_actionPerformed(e));
