...
import eu.open_ecvet.app.model.CredittransferlistCredittransfer;
import eu.open_ecvet.app.model.Unitlist;


public class CreditTransferListView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return CreditTransferListView.class.getSimpleName();
										}
										
										
										public void update()
										{
											nmListBox.setModel(CredittransferlistCredittransfer.VT,"{$CREDITTRANSFER_TITLE}",
											"CREDITTRANSFER_ID",true);
											table.refresh();
											//	comboBox.refresh();
										}
									};
	...
	public CreditTransferListView()
	{
		
	}
	
	
	public CreditTransferListView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Credittransferlist.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Credittransferlist.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setTabIndex(3);
		table.setModel(Credittransferlist.VT,"TITLE, URI",true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Credittransferlist.TITLE");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Credittransferlist.DESCRIPTION");
		textArea.setTabIndex(6);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		nmListBox.setTabIndex(13);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Credittransferlist.URI");
