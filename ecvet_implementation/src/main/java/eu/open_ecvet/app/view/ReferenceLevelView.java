...
import eu.open_ecvet.app.model.Referencelevel;
import eu.open_ecvet.app.model.Unitlist;


public class ReferenceLevelView extends XdevWindow // ${GENERATED-CODE-LINE:BEAN_SUPERCLASS}
{
	...
	private UpdateView	updateView	= new UpdateView()
									{
										...
										public String getName()
										{
											...
											return ReferenceLevelView.class.getSimpleName();
										}
	...
	public ReferenceLevelView()
	{
		
	}
	
	
	public ReferenceLevelView(MainWindow mainWindow)
	{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		...
		{
			formular.delete();
			formular.reset(Referencelevel.VT);
		}
		catch(DBException e)
		{
	...
	{// ${GENERATED-CODE-BLOCK-END:EVENT_HANDLER_DELEGATE}
		formular.reset(eu.open_ecvet.app.model.Referencelevel.VT);
	}// ${GENERATED-CODE-LINE:EVENT_HANDLER_DELEGATE}
	...
	XdevTable				table;
	XdevTextArea			textArea2, textArea;
	...
	{// Generated initializers, do not edit! ${GENERATED-CODE-BLOCK-START:INITIALIZERS}
		...
		table.setModel(Referencelevel.VT,"FRAMEWORK, FRAMEWORKLEVEL, FRAMEWORKTERM, TITLE, URI",
				true);
		label2.setText("TITLE");
		label2.setName("label2");
		textField2.setDataField("eu.open_ecvet.app.model.Referencelevel.TITLE");
		...
		textArea2.setDataField("eu.open_ecvet.app.model.Referencelevel.DESCRIPTION");
		textArea2.setTabIndex(6);
		textArea2.setMaxSignCount(Integer.MAX_VALUE);
		textArea2.setName("textArea2");
		label4.setText("FRAMEWORK");
		label4.setName("label4");
		textField3.setDataField("eu.open_ecvet.app.model.Referencelevel.FRAMEWORK");
		...
		formattedTextField.setDataField("eu.open_ecvet.app.model.Referencelevel.FRAMEWORKLEVEL");
		...
		textField4.setDataField("eu.open_ecvet.app.model.Referencelevel.FRAMEWORKTERM");
		...
		textArea.setDataField("eu.open_ecvet.app.model.Referencelevel.INDICATOR");
		textArea.setTabIndex(10);
		textArea.setMaxSignCount(Integer.MAX_VALUE);
		label.setText("URI");
		textField.setDataField("eu.open_ecvet.app.model.Referencelevel.URI");
		...
		formular.add(label3,new GBC(1,2,1,1,0.0,0.0,GBC.BASELINE_LEADING,GBC.NONE,new Insets(3,3,3,
				3),0,0));
		JScrollPane textArea2_carrier = new XScrollPane(textArea2,
				XScrollPane.VERTICAL_SCROLLBAR_ALWAYS,XScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		formular.add(textArea2_carrier,new GBC(2,2,1,1,1.0,1.0,GBC.BASELINE_LEADING,GBC.BOTH,
				new Insets(3,3,3,3),0,0));
		formular.add(label4,new GBC(1,3,1,1,0.0,0.0,GBC.BASELINE_LEADING,GBC.NONE,new Insets(3,3,3,
				3),0,0));
		formular.add(textField3,new GBC(2,3,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,
				new Insets(3,3,3,3),0,0));
		...
		formular.add(label6,new GBC(1,5,1,1,0.0,0.0,GBC.BASELINE_LEADING,GBC.NONE,new Insets(3,3,3,
				3),0,0));
		formular.add(textField4,new GBC(2,5,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,
				new Insets(3,3,3,3),0,0));
		...
		JScrollPane textArea_carrier = new XScrollPane(textArea,
				XScrollPane.VERTICAL_SCROLLBAR_ALWAYS,XScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		formular.add(textArea_carrier,new GBC(2,6,1,1,1.0,1.0,GBC.BASELINE_LEADING,GBC.BOTH,
				new Insets(3,3,3,3),0,0));
		formular.add(label,new GBC(1,7,1,1,0.0,0.0,GBC.BASELINE_LEADING,GBC.NONE,
				new Insets(3,3,3,3),0,0));
		formular.add(textField,new GBC(2,7,1,1,1.0,0.0,GBC.BASELINE_LEADING,GBC.HORIZONTAL,
				new Insets(3,3,3,3),0,0));
		formular.add(container3,new GBC(1,8,2,1,1.0,0.0,GBC.CENTER,GBC.HORIZONTAL,new Insets(3,3,3,
				3),0,0));
