...
public class EcvetH2_relationsNew extends EntityRelationshipModel implements StaticInstanceSupport // ${GENERATED-CODE-LINE:ER_SUPERCLASS}
{
	
	// Generated code, do not edit! ${GENERATED-CODE-BLOCK-START:ER_MODEL}
	private static EcvetH2_relationsNew	instance	= null;
	
	
	public static EcvetH2_relationsNew getInstance()
	{
		if(instance == null)
		{
			instance = new EcvetH2_relationsNew();
		}
		return instance;
	}
	
	{
		...
		add(LearningoutcomelistChild.class.getName(),
				new String[]{LearningoutcomelistChild.ID.getName()},Cardinality.MANY,
