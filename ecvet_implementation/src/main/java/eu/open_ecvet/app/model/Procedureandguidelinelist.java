...
public class Procedureandguidelinelist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Procedureandguidelinelist()
	{
		super(Procedureandguidelinelist.class.getName(),"PUBLIC","PROCEDUREANDGUIDELINELIST",ID,
	...
	public final static Procedureandguidelinelist	VT	= new Procedureandguidelinelist();
	
	
	public static Procedureandguidelinelist getInstance()
	{
		return VT;
	}
