...
public class CertificatetemplateAttachment extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public CertificatetemplateAttachment()
	{
		super(CertificatetemplateAttachment.class.getName(),"PUBLIC",
				"CERTIFICATETEMPLATE_ATTACHMENT",ATTACHMENTS_ID,ATTACHMENT_ID,ATTACHMENT_TITLE);
	...
	public final static CertificatetemplateAttachment	VT	= new CertificatetemplateAttachment();
	
	
	public static CertificatetemplateAttachment getInstance()
	{
		return VT;
	}
