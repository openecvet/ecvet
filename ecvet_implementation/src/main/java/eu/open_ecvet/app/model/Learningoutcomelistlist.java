...
public class Learningoutcomelistlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Learningoutcomelistlist()
	{
		super(Learningoutcomelistlist.class.getName(),"PUBLIC","LEARNINGOUTCOMELISTLIST",ID,
	...
	public final static Learningoutcomelistlist	VT	= new Learningoutcomelistlist();
	
	
	public static Learningoutcomelistlist getInstance()
	{
		return VT;
	}
