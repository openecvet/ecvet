...
public class Validationlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	{
		super(Validationlist.class.getName(),"PUBLIC","VALIDATIONLIST",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Validationlist	VT	= new Validationlist();
	
	
	public static Validationlist getInstance()
	{
		return VT;
	}
