...
public class Transcriptionofrecordlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Transcriptionofrecordlist()
	{
		super(Transcriptionofrecordlist.class.getName(),"PUBLIC","TRANSCRIPTIONOFRECORDLIST",ID,
	...
	public final static Transcriptionofrecordlist	VT	= new Transcriptionofrecordlist();
	
	
	public static Transcriptionofrecordlist getInstance()
	{
		return VT;
	}
