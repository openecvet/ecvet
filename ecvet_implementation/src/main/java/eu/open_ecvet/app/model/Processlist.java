...
public class Processlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Processlist()
	{
		super(Processlist.class.getName(),"PUBLIC","PROCESSLIST",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Processlist	VT	= new Processlist();
