...
public class Certificatetemplate extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	{
		super(Certificatetemplate.class.getName(),"PUBLIC","CERTIFICATETEMPLATE",ID,DESCRIPTION,
				TITLE,URI);
	...
	public final static Certificatetemplate	VT	= new Certificatetemplate();
	
	
	public static Certificatetemplate getInstance()
	{
		return VT;
	}
