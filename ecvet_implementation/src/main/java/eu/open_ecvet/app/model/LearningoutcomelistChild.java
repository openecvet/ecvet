...
public class LearningoutcomelistChild extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	static
	{
		...
		EVALUATIONS_TITLE
				.setTableColumnLink(new TableColumnLink(Evaluations.class.getName(),
						Evaluations.TITLE.getName(),new EntityRelationship(Evaluations.class
								...
								LearningoutcomelistChild.class.getName(),
								new String[]{LearningoutcomelistChild.EVALUATIONS_ID.getName()},
								Cardinality.MANY)));
		...
		QUALIFICATIONFRAMEWORKLIST_TITLE.setTableColumnLink(new TableColumnLink(
				Qualificationframeworklist.class.getName(),Qualificationframeworklist.TITLE
						...
						Cardinality.ONE,LearningoutcomelistChild.class.getName(),
						new String[]{LearningoutcomelistChild.QUALIFICATIONFRAMEWORKLIST_ID.getName()},
						Cardinality.MANY)));
	}
	
	
	public LearningoutcomelistChild()
	{
		super(LearningoutcomelistChild.class.getName(),"PUBLIC","LEARNINGOUTCOMELIST",ID,DESCRIPTION,
				TITLE,URI,EVALUATIONS_ID,EVALUATIONS_TITLE,QUALIFICATIONFRAMEWORKLIST_ID,
				QUALIFICATIONFRAMEWORKLIST_TITLE);
		...
		addIndex(new Index("FK_LEARNINGOUTCOMELIST_EVALUATIONS_ID_INDEX_1",IndexType.NORMAL,
				"EVALUATIONS_ID"));
	...
	public final static LearningoutcomelistChild	VT	= new LearningoutcomelistChild();
	
	
	public static LearningoutcomelistChild getInstance()
	{
		return VT;
	}
