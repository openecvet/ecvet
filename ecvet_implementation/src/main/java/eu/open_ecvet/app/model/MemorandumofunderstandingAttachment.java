...
public class MemorandumofunderstandingAttachment extends VirtualTable implements
		StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public MemorandumofunderstandingAttachment()
	{
		super(MemorandumofunderstandingAttachment.class.getName(),"PUBLIC",
				"MEMORANDUMOFUNDERSTANDING_ATTACHMENT",ATTACHMENTS_ID,ATTACHMENT_ID,
				ATTACHMENT_TITLE);
	...
	public final static MemorandumofunderstandingAttachment	VT	= new MemorandumofunderstandingAttachment();
	
	
	public static MemorandumofunderstandingAttachment getInstance()
	{
		return VT;
	}
