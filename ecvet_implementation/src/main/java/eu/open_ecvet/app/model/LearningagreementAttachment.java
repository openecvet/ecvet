...
public class LearningagreementAttachment extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	static
	{
		...
		ATTACHMENT_TITLE.setTableColumnLink(new TableColumnLink(Attachment.class.getName(),
				Attachment.TITLE.getName(),new EntityRelationship(Attachment.class.getName(),
						...
						new String[]{LearningagreementAttachment.ATTACHMENT_ID.getName()},
						Cardinality.MANY)));
	}
	
	
	public LearningagreementAttachment()
	{
		super(LearningagreementAttachment.class.getName(),"PUBLIC","LEARNINGAGREEMENT_ATTACHMENT",
	...
	public final static LearningagreementAttachment	VT	= new LearningagreementAttachment();
	
	
	public static LearningagreementAttachment getInstance()
	{
		return VT;
	}
