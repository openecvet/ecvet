...
public class Partner extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Partner()
	{
		super(Partner.class.getName(),"PUBLIC","PARTNER",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Partner	VT	= new Partner();
