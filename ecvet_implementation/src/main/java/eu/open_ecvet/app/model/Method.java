...
public class Method extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Method()
	{
		super(Method.class.getName(),"PUBLIC","METHOD",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Method	VT	= new Method();
