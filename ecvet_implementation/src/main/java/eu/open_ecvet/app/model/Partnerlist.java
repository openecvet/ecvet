...
public class Partnerlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Partnerlist()
	{
		super(Partnerlist.class.getName(),"PUBLIC","PARTNERLIST",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Partnerlist	VT	= new Partnerlist();
	
	
	public static Partnerlist getInstance()
	{
		return VT;
	}
