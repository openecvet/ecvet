...
public class Credittransfer extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	{
		super(Credittransfer.class.getName(),"PUBLIC","CREDITTRANSFER",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Credittransfer	VT	= new Credittransfer();
	
	
	public static Credittransfer getInstance()
	{
		return VT;
	}
