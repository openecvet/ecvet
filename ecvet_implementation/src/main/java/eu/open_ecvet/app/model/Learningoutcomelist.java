...
public class Learningoutcomelist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
		...
		EVALUATIONS_TITLE
				.setTableColumnLink(new TableColumnLink(Evaluations.class.getName(),
						Evaluations.TITLE.getName(),new EntityRelationship(Evaluations.class
								...
								new String[]{Learningoutcomelist.EVALUATIONS_ID.getName()},
								Cardinality.MANY)));
	...
	public static Learningoutcomelist getInstance()
	{
		return VT;
	}
