...
public class UserguideAttachment extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	static
	{
		...
		ATTACHMENT_TITLE
				.setTableColumnLink(new TableColumnLink(Attachment.class.getName(),Attachment.TITLE
						.getName(),new EntityRelationship(Attachment.class.getName(),
	...
	{
		super(UserguideAttachment.class.getName(),"PUBLIC","USERGUIDE_ATTACHMENT",ATTACHMENTS_ID,
	...
	public final static UserguideAttachment	VT	= new UserguideAttachment();
	
	
	public static UserguideAttachment getInstance()
	{
		return VT;
	}
