...
public class Legislationlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	{
		super(Legislationlist.class.getName(),"PUBLIC","LEGISLATIONLIST",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Legislationlist	VT	= new Legislationlist();
	
	
	public static Legislationlist getInstance()
	{
		return VT;
	}
