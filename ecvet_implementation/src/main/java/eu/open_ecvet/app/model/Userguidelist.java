...
public class Userguidelist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Userguidelist()
	{
		super(Userguidelist.class.getName(),"PUBLIC","USERGUIDELIST",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Userguidelist	VT	= new Userguidelist();
	
	
	public static Userguidelist getInstance()
	{
		return VT;
	}
