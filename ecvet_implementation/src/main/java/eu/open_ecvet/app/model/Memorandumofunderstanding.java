...
public class Memorandumofunderstanding extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Memorandumofunderstanding()
	{
		super(Memorandumofunderstanding.class.getName(),"PUBLIC","MEMORANDUMOFUNDERSTANDING",ID,
	...
	public final static Memorandumofunderstanding	VT	= new Memorandumofunderstanding();
	
	
	public static Memorandumofunderstanding getInstance()
	{
		return VT;
	}
