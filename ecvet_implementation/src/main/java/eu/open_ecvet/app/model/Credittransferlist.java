...
public class Credittransferlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Credittransferlist()
	{
		super(Credittransferlist.class.getName(),"PUBLIC","CREDITTRANSFERLIST",ID,DESCRIPTION,
				TITLE,URI);
	...
	public final static Credittransferlist	VT	= new Credittransferlist();
	
	
	public static Credittransferlist getInstance()
	{
		return VT;
	}
