...
public class Recognitionlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	{
		super(Recognitionlist.class.getName(),"PUBLIC","RECOGNITIONLIST",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Recognitionlist	VT	= new Recognitionlist();
	
	
	public static Recognitionlist getInstance()
	{
		return VT;
	}
