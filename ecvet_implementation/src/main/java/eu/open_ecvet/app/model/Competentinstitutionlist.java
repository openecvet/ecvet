...
public class Competentinstitutionlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Competentinstitutionlist()
	{
		super(Competentinstitutionlist.class.getName(),"PUBLIC","COMPETENTINSTITUTIONLIST",ID,
	...
	public final static Competentinstitutionlist	VT	= new Competentinstitutionlist();
	
	
	public static Competentinstitutionlist getInstance()
	{
		return VT;
	}
