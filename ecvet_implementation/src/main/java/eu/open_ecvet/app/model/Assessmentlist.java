...
public class Assessmentlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	{
		super(Assessmentlist.class.getName(),"PUBLIC","ASSESSMENTLIST",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Assessmentlist	VT	= new Assessmentlist();
	
	
	public static Assessmentlist getInstance()
	{
		return VT;
	}
