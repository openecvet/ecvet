...
public class Userguide extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Userguide()
	{
		super(Userguide.class.getName(),"PUBLIC","USERGUIDE",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Userguide	VT	= new Userguide();
