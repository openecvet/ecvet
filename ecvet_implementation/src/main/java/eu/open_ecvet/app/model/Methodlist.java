...
public class Methodlist extends VirtualTable implements StaticInstanceSupport // ${GENERATED-CODE-LINE:VT_SUPERCLASS}
{
	...
	public Methodlist()
	{
		super(Methodlist.class.getName(),"PUBLIC","METHODLIST",ID,DESCRIPTION,TITLE,URI);
	...
	public final static Methodlist	VT	= new Methodlist();
